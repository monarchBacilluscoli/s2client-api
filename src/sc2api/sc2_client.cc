...
namespace sc2
{
    ...
    ObservationImp::ObservationImp(ProtoInterface &proto, ObservationPtr &observation, ResponseObservationPtr &response, ControlInterface &control) : proto_(proto),
    ...
    QueryImp::QueryImp(ProtoInterface &proto, ControlInterface &control, ObservationInterface &observation) : proto_(proto),
                                                                                                              control_(control),
                                                                                                              observation_(observation)
    {
    }
    ...
    DebugImp::DebugImp(ProtoInterface &proto, ObservationInterface &observation, ControlInterface &control) : proto_(proto),
                                                                                                              observation_(observation),
                                                                                                              control_(control),
    ...
    public:
        ...
        void SetAppState(AppState stat) override;
    };

    ControlImp::ControlImp(Client &client) : client_(client),
    ...
    void ControlImp::SetAppState(AppState stat)
    {
        app_state_ = stat;
    }
    ...
    bool IsCarryingVespene(const Unit &unit)
    {
        auto is_vespene = [](const BuffID &buff) {
            return buff == BUFF_ID::CARRYHARVESTABLEVESPENEGEYSERGAS || buff == BUFF_ID::CARRYHARVESTABLEVESPENEGEYSERGASPROTOSS || buff == BUFF_ID::CARRYHARVESTABLEVESPENEGEYSERGASZERG;
        };
