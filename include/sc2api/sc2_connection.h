...
namespace sc2
{
    ...
    void StartCivetweb(); //! modified by liuyongfeng, i guess if you want to try multiple coordinator, you need to run this before any other games start to avoid race condition.
